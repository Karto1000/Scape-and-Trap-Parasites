...
public class ModEntities {
    public static final EntityEntry SENTRY_TURRET_ENTITY = EntityEntryBuilder.create()
            .entity(SentryTurretEntity.class)
            .id(new ResourceLocation(SRParasitesTraps.MOD_ID, "sentry_turret"), 1)
            .name("sentry_turret")
            .tracker(64, 1, true)
            .build();
    public static final EntityEntry SENTRY_TURRET_SPINEBALL_ENTITY = EntityEntryBuilder.create()
            ...
            .build();
    public static final EntityEntry SENTRY_TURRET_ALAPHA_BALL_ENTITY = EntityEntryBuilder.create()
            ...
            .build();
    public static final EntityEntry RELOCATOR_ENTITY = EntityEntryBuilder.create()
