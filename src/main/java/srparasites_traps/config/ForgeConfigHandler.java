...
public class ForgeConfigHandler {
    ...
    //Needed on config classes that contain MixinToggles for those mixins to be added
    public static class ServerConfig {
        ...
        @MixinConfig.MixinToggle(earlyMixin = "mixins.srparasites_traps.vanilla.json", defaultValue = false)
        ...
        @MixinConfig.MixinToggle(lateMixin = "mixins.srpparasites_traps.jei.json", defaultValue = false)
