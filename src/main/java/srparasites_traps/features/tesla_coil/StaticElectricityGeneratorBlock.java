...
public class StaticElectricityGeneratorBlock extends Block {
    public static final String REGISTRY_NAME = "static_electricity_generator";

    public StaticElectricityGeneratorBlock() {
