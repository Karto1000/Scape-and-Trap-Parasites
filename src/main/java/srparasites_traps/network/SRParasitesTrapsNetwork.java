...
public class SRParasitesTrapsNetwork {
    ...
    public static void init() {
        ...
        CHANNEL.registerMessage(RemoveEntityFromTargetingAugment.Handler.class, RemoveEntityFromTargetingAugment.class, 2, Side.SERVER);
        CHANNEL.registerMessage(UpdateTargetingMode.Handler.class, UpdateTargetingMode.class, 3, Side.SERVER);
    }
}
